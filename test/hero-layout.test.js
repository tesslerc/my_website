...
assert.match(css, /@media \(min-width: 821px\) \{[\s\S]*?\.profile-links\s*\{[^}]*padding-top:\s*clamp\(1\.75rem, 2\.5vw, 2\.5rem\)/, "desktop About me links should have clearly visible non-collapsing breathing room below the hero lede");
