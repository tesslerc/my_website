...
assert.match(css, /@media \(min-width: 821px\) \{[\s\S]*?\.profile-links\s*\{[^}]*padding-top:\s*clamp\(0\.75rem, 1\.2vw, 1rem\)/, "desktop About me links should have non-collapsing breathing room below the hero lede");
